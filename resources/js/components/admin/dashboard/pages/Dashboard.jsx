        ...
        <div className="container-fluid">
                    ...
                    <div className="page-title-box">
                        <div className="page-title-right">
                            <form className="d-flex">
                                ...
                                <NavLink to="javascript: void(0);" className="btn btn-primary ms-2">
                                    <i className="mdi mdi-autorenew" />
                                </NavLink>
                                <NavLink to="javascript: void(0);" className="btn btn-primary ms-1">
                        ...
                        <div className="card-body">
                            <div className="dropdown float-end">
                                ...
                                <div className="dropdown-menu dropdown-menu-end">
                                    <NavLink to="javascript:void(0);" className="dropdown-item">
                                        Sales Report
                                    </NavLink>
                ...
                <div className="col-lg-8">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="chart-Dashboard-bg">
                            ...
                            <div className="dash-item-overlay d-none d-md-block" dir="ltr">
                                ...
                                <NavLink to="javascript: void(0);" className="btn btn-outline-primary">
                                    View Statements
            ...
            <div className="row">
                <div className="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                    <div className="card">
                        <div className="card-body">
                            <NavLink to="" className="btn btn-sm btn-NavLink float-end">
                                Export
                                ...
                                <div className="timeline-alt pb-0">
                                    <div className="timeline-item">
                                        ...
                                        <div className="timeline-item-info">
                                            <NavLink to="#" className="text-info fw-bold mb-1 d-block">
                                                You sold an item
                                            </NavLink>
                                            <small>
                                    ...
                                    <div className="timeline-item">
                                        ...
                                        <div className="timeline-item-info">
                                            <NavLink to="#" className="text-primary fw-bold mb-1 d-block">
